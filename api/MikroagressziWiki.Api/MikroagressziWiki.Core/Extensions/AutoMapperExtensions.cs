...
namespace MikroagressziWiki.Core.Extensions
{
    public static class AutoMapperExtensions
    {
        ...
        /// <param name="source">The source collection to be mapped.</param>
        /// <returns></returns>
        public static IList<TDestination> MapCollection<TSource, TDestination>(this IRuntimeMapper mapper, IList<TSource> source)
        {
            return mapper.Map<IList<TSource>, IList<TDestination>>(source);
        }
    }
